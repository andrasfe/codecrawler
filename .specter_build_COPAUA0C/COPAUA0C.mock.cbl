      ...
      * SPECTER PATCH: cobc-undefined fallback declarations
       ...
       01 MQGMO-CONVERT                  PIC X(256).
       01 MQGMO-FAIL-IF-QUIESCING        PIC X(256).
       01 MQGMO-NO-SYNCPOINT             PIC X(256).
       01 MQGMO-OPTIONS                  PIC X(256).
      ...
      ******************************************************************        
       ...
       01  MQM-OD-REQUEST.                                                      
      * SPECTER: COPY CMQODV (not found)
       05 SPECTER-MISSING-CMQODV PIC X.
                                                                                
       01  MQM-MD-REQUEST.                                                      
      * SPECTER: COPY CMQMDV (not found)
       05 SPECTER-MISSING-CMQMDV PIC X.
      ...
      * SPECTER: COPY CMQMDV (not found)
       ...
       01  MQM-CONSTANTS.                                                       
      * SPECTER: COPY CMQV (not found)
       05 SPECTER-MISSING-CMQV PIC X.
                                                                                
       01  MQM-TRIGGER-DATA.                                                    
      * SPECTER: COPY CMQTML (not found)
       05 SPECTER-MISSING-CMQTML PIC X.
                                                                                
       01  MQM-PUT-MESSAGE-OPTIONS.                                             
      * SPECTER: COPY CMQPMOV (not found)
       05 SPECTER-MISSING-CMQPMOV PIC X.
                                                                                
       01  MQM-GET-MESSAGE-OPTIONS.                                             
      * SPECTER: COPY CMQGMOV (not found)
       05 SPECTER-MISSING-CMQGMOV PIC X.
      ...
      * SPECTER: COPY CCPAURQY inlined from CCPAURQY.cpy
      *****************************************************************         
      ...
      ******************************************************************
           ...
           05  PA-RQ-MESSAGE-SOURCE         PIC  X(06).                         
           05  PA-RQ-PROCESSING-CODE        PIC  9(06).                         
           05  PA-RQ-TRANSACTION-AMT        PIC +9(10).99.                      
           05  PA-RQ-MERCHANT-CATAGORY-CODE PIC  X(04).                         
           05  PA-RQ-ACQR-COUNTRY-CODE      PIC  X(03).                         
           05  PA-RQ-POS-ENTRY-MODE         PIC  9(02).                         
           05  PA-RQ-MERCHANT-ID            PIC  X(15).                         
           05  PA-RQ-MERCHANT-NAME          PIC  X(22).                         
      ...
      * SPECTER: COPY CCPAURLY inlined from CCPAURLY.cpy
      *****************************************************************         
      ...
      * SPECTER: COPY CCPAUERY inlined from CCPAUERY.cpy
      *****************************************************************
      ...
      * SPECTER: COPY CIPAUSMY inlined from CIPAUSMY.cpy
      *****************************************************************         
      ...
      * SPECTER: COPY CIPAUDTY inlined from CIPAUDTY.cpy
      *****************************************************************         
      ...
      *                       WS-REASON                                         
      *    END-CALL                                                             
      *    DISPLAY 'SPECTER-MOCK:CALL:MQGET'
      *    READ MOCK-FILE INTO MOCK-RECORD
      *       AT END
      *         MOVE 0 TO MOCK-NUM-STATUS
      *    END-READ
