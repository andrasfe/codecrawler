      ...
      * SPECTER: COPY COUSR01 (not found)
      ...
      *    CONTINUE.
       S-SEND-USRADD-SCREEN.
           DISPLAY 'SPECTER-TRACE:S-SEND-USRADD-SCREEN'.
      *    CONTINUE.
       RECEIVE-USRADD-SCREEN.
           DISPLAY 'SPECTER-TRACE:RECEIVE-USRADD-SCREEN'.
      *    CONTINUE.
       POPULATE-HEADER-INFO.
           DISPLAY 'SPECTER-TRACE:POPULATE-HEADER-INFO'.
      *    CONTINUE.
       WRITE-USER-SEC-FILE.
           DISPLAY 'SPECTER-TRACE:WRITE-USER-SEC-FILE'.
      *    CONTINUE.
      ...
      *    DISPLAY 'SPECTER-CALL:FROM=MAIN-PARA:TO=S-SEND-USRADD-SCREEN'. 
      *            PERFORM S-SEND-USRADD-SCREEN 
      *        ELSE
      *    DISPLAY 'SPECTER-CALL:FROM=MAIN-PARA:TO=RECEIVE-USRADD-SCREEN'.
      *            PERFORM RECEIVE-USRADD-SCREEN
      *            EVALUATE EIBAID
      *                WHEN DFHENTER
      ...
      *                            WS-MESSAGE
      *            MOVE -1       TO FNAMEL OF COUSR1AI
      *    DISPLAY 'SPECTER-CALL:FROM=PROCESS-ENTER-KEY:TO=SEND-USRADD-SCREEN'.
      *            PERFORM S-SEND-USRADD-SCREEN 
      ...
      *    DISPLAY 'SPECTER-CALL:FROM=PROCESS-ENTER-KEY:TO=WRITE-USER-SEC-FILE'.
      *        PERFORM WRITE-USER-SEC-FILE
      *    END-IF.
      ...
      *    DISPLAY 'SPECTER-CALL:FROM=S-SEND-USRADD-SCREEN:TO=POPULATE-HEA
      *    PERFORM POPULATE-HEADER-INFO
      ...
      *    EVALUATE WS-RESP-CD
      *        WHEN 0
      *    DISPLAY 'SPECTER-CALL:FROM=WRITE-USER-SEC-FILE:TO=INITIALIZE-ALL-FIELDS'.
      *            PERFORM INITIALIZE-ALL-FIELDS
      *            MOVE SPACES             TO WS-MESSAGE
      ...
      *              INTO WS-MESSAGE
      *    DISPLAY 'SPECTER-CALL:FROM=WRITE-USER-SEC-FILE:TO=SEND-USRADD-SCREEN'.
      *            PERFORM S-SEND-USRADD-SCREEN 
      *        WHEN 15
      *        WHEN 14
      *            MOVE 'Y'     TO WS-ERR-FLG
      ...
      *    PERFORM INITIALIZE-ALL-FIELDS.
      *    DISPLAY 'SPECTER-CALL:FROM=CLEAR-CURRENT-SCREEN:TO=SEND-USRADD-SCREEN'.
      *    PERFORM S-SEND-USRADD-SCREEN. 
